        ...
        if ($request->ajax() ) 
        {
            ...
            return datatables::of($provinsi)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn .= '&nbsp;&nbsp;';
                    $btn .= '&nbsp;&nbsp;';
                    $btn = $btn.' <a href="javascript:void(0)" data-toggle="tooltip"  data-provinsi_id="'.$row->provinsi_id .'" 
                                        data-original-title="Delete" class="btn btn-danger btn-sm deleteProvinsi">Delete
                                 </a>';
                    return $btn;
                })
                ->rawColumns(['action'])
